...
class Cifar10Net(nn.Module):
    def __init__(self, input_size=32, temperature=1, raw_logits=True):  # Add input size for flexibility
        ...
        """
        super().__init__()
        self.conv1a = nn.Conv2d(3, 64, 3, padding=0)
        self.conv1b = nn.Conv2d(64, 64, 3, padding=0)
        self.conv2a = nn.Conv2d(64, 128, 3, padding=0)
        self.conv2b = nn.Conv2d(128, 128, 3, padding=0)
